...
## Main:        Hyperspectral data import
## Version:     3.1
## Creation:    2022-II-25
## Last edited: 2022-VIII-10
...
rgb <- brick(
  rasterFromXYZ(data.frame(G1D1df$x, G1D1df$y, G1D1df$`664`)),
  rasterFromXYZ(data.frame(G1D1df$x, G1D1df$y, G1D1df$`550`)),
  rasterFromXYZ(data.frame(G1D1df$x, G1D1df$y, G1D1df$`470`)))
...
rgb <- brick(
  rasterFromXYZ(data.frame(G2D1df$x, G2D1df$y, G2D1df$`664`)),
  rasterFromXYZ(data.frame(G2D1df$x, G2D1df$y, G2D1df$`550`)),
  rasterFromXYZ(data.frame(G2D1df$x, G2D1df$y, G2D1df$`470`)))
...
plotRGB(rgb,
        ...
        stretch = "lin",
        axes = TRUE,
        main = "Georgina Plant 2 Day 1") 
lines(spPolygons(bbox.stem, crs = crs(rgb)), col = "red", lwd = 3) 
lines(spPolygons(bbox.newleaf, crs = crs(rgb)), col = "red", lwd = 3)
lines(spPolygons(bbox.oldleaf, crs = crs(rgb)), col = "red", lwd = 3) 
dev.print(device = jpeg,
          filename = "RGB with bbox/G2D1.jpeg",
          width = 850,
          height = 500)
...
rm(G2D1df, G2D1stem, G2D1newleaf, G2D1oldleaf, rgb, bbox.centre.newleaf, bbox.centre.oldleaf, bbox.centre.stem,
   bbox.newleaf, bbox.oldleaf, bbox.side, bbox.stem)
dev.off()
gc()
...
rgb <- brick(
  rasterFromXYZ(data.frame(G3D1df$x, G3D1df$y, G3D1df$`664`)),
  rasterFromXYZ(data.frame(G3D1df$x, G3D1df$y, G3D1df$`550`)),
  rasterFromXYZ(data.frame(G3D1df$x, G3D1df$y, G3D1df$`470`)))
...
plotRGB(rgb,
        ...
        stretch = "lin",
        axes = TRUE,
        main = "Georgina Plant 3 Day 1") 
lines(spPolygons(bbox.stem, crs = crs(rgb)), col = "red", lwd = 3) 
lines(spPolygons(bbox.newleaf, crs = crs(rgb)), col = "red", lwd = 3)
lines(spPolygons(bbox.oldleaf, crs = crs(rgb)), col = "red", lwd = 3) 
dev.print(device = jpeg,
          filename = "RGB with bbox/G3D1.jpeg",
          width = 850,
          height = 500)
...
rm(G3D1df, G3D1stem, G3D1newleaf, G3D1oldleaf, rgb, bbox.centre.newleaf, bbox.centre.oldleaf, bbox.centre.stem,
   bbox.newleaf, bbox.oldleaf, bbox.side, bbox.stem)
dev.off()
gc()
...
rgb <- brick(
  rasterFromXYZ(data.frame(G4D1df$x, G4D1df$y, G4D1df$`664`)),
  rasterFromXYZ(data.frame(G4D1df$x, G4D1df$y, G4D1df$`550`)),
  rasterFromXYZ(data.frame(G4D1df$x, G4D1df$y, G4D1df$`470`)))
...
plotRGB(rgb,
        ...
        stretch = "lin",
        axes = TRUE,
        main = "Georgina Plant 4 Day 1")
lines(spPolygons(bbox.stem, crs = crs(rgb)), col = "red", lwd = 3) 
lines(spPolygons(bbox.newleaf, crs = crs(rgb)), col = "red", lwd = 3)
lines(spPolygons(bbox.oldleaf, crs = crs(rgb)), col = "red", lwd = 3) 
dev.print(device = jpeg,
          filename = "RGB with bbox/G4D1.jpeg",
          width = 850,
          height = 500)
...
rm(G4D1df, G4D1stem, G4D1newleaf, G4D1oldleaf, rgb, bbox.centre.newleaf, bbox.centre.oldleaf, bbox.centre.stem,
   bbox.newleaf, bbox.oldleaf, bbox.side, bbox.stem)
dev.off()
gc()
...
rgb <- brick(
  rasterFromXYZ(data.frame(G5D1df$x, G5D1df$y, G5D1df$`664`)),
  rasterFromXYZ(data.frame(G5D1df$x, G5D1df$y, G5D1df$`550`)),
  rasterFromXYZ(data.frame(G5D1df$x, G5D1df$y, G5D1df$`470`)))
...
plotRGB(rgb,
        ...
        stretch = "lin",
        axes = TRUE,
        main = "Georgina Plant 5 Day 1")
lines(spPolygons(bbox.stem, crs = crs(rgb)), col = "red", lwd = 3) 
lines(spPolygons(bbox.newleaf, crs = crs(rgb)), col = "red", lwd = 3)
lines(spPolygons(bbox.oldleaf, crs = crs(rgb)), col = "red", lwd = 3) 
dev.print(device = jpeg,
          filename = "RGB with bbox/G5D1.jpeg",
          width = 850,
          height = 500)
...
rm(G5D1df, G5D1stem, G5D1newleaf, G5D1oldleaf, rgb, bbox.centre.newleaf, bbox.centre.oldleaf, bbox.centre.stem,
   bbox.newleaf, bbox.oldleaf, bbox.side, bbox.stem)
dev.off()
gc()

# 2.2.6 Georgina plant 6 (day 1) ####

G6D1 <- read.ENVI(
  file = D1.dat[11],
  headerfile = D1.hdr[11],
  header = list(),
  keys.hdr2data = FALSE,
  wavelength = NULL,
  label = list(),
...
G6D1df <- as.wide.df(G6D1)
rm(G6D1)

rgb <- brick(
  rasterFromXYZ(data.frame(G6D1df$x, G6D1df$y, G6D1df$`664`)),
  rasterFromXYZ(data.frame(G6D1df$x, G6D1df$y, G6D1df$`550`)),
  rasterFromXYZ(data.frame(G6D1df$x, G6D1df$y, G6D1df$`470`)))
...
plotRGB(rgb,
        ...
        stretch = "lin",
        axes = TRUE,
        main = "Georgina Plant 6 Day 1")
lines(spPolygons(bbox.stem, crs = crs(rgb)), col = "red", lwd = 3) 
lines(spPolygons(bbox.newleaf, crs = crs(rgb)), col = "red", lwd = 3)
lines(spPolygons(bbox.oldleaf, crs = crs(rgb)), col = "red", lwd = 3)

dev.print(device = jpeg,
          filename = "RGB with bbox/G6D1.jpeg",
          width = 850,
          height = 500)

G6D1stem <- subset(G6D1df, x >= bbox.stem[1,1] & x <= bbox.stem[3,1] &
                     y >= bbox.stem[1,2] & y <= bbox.stem[3,2])
G6D1stem$Tissue <- "Stem"

G6D1newleaf <- subset(G6D1df, x >= bbox.newleaf[1,1] & x <= bbox.newleaf[3,1] &
                        y >= bbox.newleaf[1,2] & y <= bbox.newleaf[3,2])
G6D1newleaf$Tissue <- "New leaf"

G6D1oldleaf <- subset(G6D1df, x >= bbox.oldleaf[1,1] & x <= bbox.oldleaf[3,1] &
                        y >= bbox.oldleaf[1,2] & y <= bbox.oldleaf[3,2])
G6D1oldleaf$Tissue <- "Old leaf"

data.G6D1 <- rbind(G6D1stem, G6D1newleaf, G6D1oldleaf)
data.G6D1$Time <- "Day 1"
data.G6D1$Variety <- "Georgina"
data.G6D1$Plant <- "Plant 6"
rm(G6D1df, G6D1stem, G6D1newleaf, G6D1oldleaf, rgb, bbox.centre.newleaf, bbox.centre.oldleaf, bbox.centre.stem,
   bbox.newleaf, bbox.oldleaf, bbox.side, bbox.stem)
dev.off()
gc()

# 2.2.7 Georgina plant 7 (day 1) ####

G7D1 <- read.ENVI(
  file = D1.dat[12],
  headerfile = D1.hdr[12],
  header = list(),
  keys.hdr2data = FALSE,
  wavelength = NULL,
  label = list(),
...
G7D1df <- as.wide.df(G7D1)
rm(G7D1)

rgb <- brick(
  rasterFromXYZ(data.frame(G7D1df$x, G7D1df$y, G7D1df$`664`)),
  rasterFromXYZ(data.frame(G7D1df$x, G7D1df$y, G7D1df$`550`)),
  rasterFromXYZ(data.frame(G7D1df$x, G7D1df$y, G7D1df$`470`)))
...
plotRGB(rgb,
        ...
        stretch = "lin",
        axes = TRUE,
        main = "Georgina Plant 7 Day 1")
lines(spPolygons(bbox.stem, crs = crs(rgb)), col = "red", lwd = 3) 
lines(spPolygons(bbox.newleaf, crs = crs(rgb)), col = "red", lwd = 3)
lines(spPolygons(bbox.oldleaf, crs = crs(rgb)), col = "red", lwd = 3) 
dev.print(device = jpeg,
          filename = "RGB with bbox/G7D1.jpeg",
          width = 850,
          height = 500)

G7D1stem <- subset(G7D1df, x >= bbox.stem[1,1] & x <= bbox.stem[3,1] &
                     y >= bbox.stem[1,2] & y <= bbox.stem[3,2])
G7D1stem$Tissue <- "Stem"

G7D1newleaf <- subset(G7D1df, x >= bbox.newleaf[1,1] & x <= bbox.newleaf[3,1] &
                        y >= bbox.newleaf[1,2] & y <= bbox.newleaf[3,2])
G7D1newleaf$Tissue <- "New leaf"

G7D1oldleaf <- subset(G7D1df, x >= bbox.oldleaf[1,1] & x <= bbox.oldleaf[3,1] &
                        y >= bbox.oldleaf[1,2] & y <= bbox.oldleaf[3,2])
G7D1oldleaf$Tissue <- "Old leaf"

data.G7D1 <- rbind(G7D1stem, G7D1newleaf, G7D1oldleaf)
data.G7D1$Time <- "Day 1"
data.G7D1$Variety <- "Georgina"
data.G7D1$Plant <- "Plant 7"
rm(G7D1df, G7D1stem, G7D1newleaf, G7D1oldleaf, rgb, bbox.centre.newleaf, bbox.centre.oldleaf, bbox.centre.stem,
   bbox.newleaf, bbox.oldleaf, bbox.side, bbox.stem)
dev.off()
gc()

# 2.2.8 Georgina plant 8 (day 1) ####

G8D1 <- read.ENVI(
  file = D1.dat[13],
  headerfile = D1.hdr[13],
  header = list(),
  keys.hdr2data = FALSE,
  wavelength = NULL,
  label = list(),
...
G8D1df <- as.wide.df(G8D1)
rm(G8D1)

rgb <- brick(
  rasterFromXYZ(data.frame(G8D1df$x, G8D1df$y, G8D1df$`664`)),
  rasterFromXYZ(data.frame(G8D1df$x, G8D1df$y, G8D1df$`550`)),
  rasterFromXYZ(data.frame(G8D1df$x, G8D1df$y, G8D1df$`470`)))
...
plotRGB(rgb,
        ...
        stretch = "lin",
        axes = TRUE,
        main = "Georgina Plant 8 Day 1")
lines(spPolygons(bbox.stem, crs = crs(rgb)), col = "red", lwd = 3) 
lines(spPolygons(bbox.newleaf, crs = crs(rgb)), col = "red", lwd = 3)
lines(spPolygons(bbox.oldleaf, crs = crs(rgb)), col = "red", lwd = 3) 
dev.print(device = jpeg,
          filename = "RGB with bbox/G8D1.jpeg",
          width = 850,
          height = 500)

G8D1stem <- subset(G8D1df, x >= bbox.stem[1,1] & x <= bbox.stem[3,1] &
                     y >= bbox.stem[1,2] & y <= bbox.stem[3,2])
G8D1stem$Tissue <- "Stem"

G8D1newleaf <- subset(G8D1df, x >= bbox.newleaf[1,1] & x <= bbox.newleaf[3,1] &
                        y >= bbox.newleaf[1,2] & y <= bbox.newleaf[3,2])
G8D1newleaf$Tissue <- "New leaf"

G8D1oldleaf <- subset(G8D1df, x >= bbox.oldleaf[1,1] & x <= bbox.oldleaf[3,1] &
                        y >= bbox.oldleaf[1,2] & y <= bbox.oldleaf[3,2])
G8D1oldleaf$Tissue <- "Old leaf"

data.G8D1 <- rbind(G8D1stem, G8D1newleaf, G8D1oldleaf)
data.G8D1$Time <- "Day 1"
data.G8D1$Variety <- "Georgina"
data.G8D1$Plant <- "Plant 8"
rm(G8D1df, G8D1stem, G8D1newleaf, G8D1oldleaf, rgb, bbox.centre.newleaf, bbox.centre.oldleaf, bbox.centre.stem,
   bbox.newleaf, bbox.oldleaf, bbox.side, bbox.stem)
dev.off()
gc()

# 2.2.9 Georgina day 1 data export ####
data.GD1 <- rbind(data.G1D1, data.G2D1, data.G3D1, data.G4D1, data.G5D1, data.G6D1, data.G7D1, data.G8D1)
rm(data.G1D1, data.G2D1, data.G3D1, data.G4D1, data.G5D1, data.G6D1, data.G7D1, data.G8D1)
...
rgb <- brick(
  rasterFromXYZ(data.frame(J1D1df$x, J1D1df$y, J1D1df$`664`)),
  rasterFromXYZ(data.frame(J1D1df$x, J1D1df$y, J1D1df$`550`)),
  rasterFromXYZ(data.frame(J1D1df$x, J1D1df$y, J1D1df$`470`)))
...
plotRGB(rgb,
        ...
        stretch = "lin",
        axes = TRUE,
        main = "Juliet Plant 1 Day 1")
lines(spPolygons(bbox.stem, crs = crs(rgb)), col = "red", lwd = 3) 
lines(spPolygons(bbox.newleaf, crs = crs(rgb)), col = "red", lwd = 3)
lines(spPolygons(bbox.oldleaf, crs = crs(rgb)), col = "red", lwd = 3) 
dev.print(device = jpeg,
          filename = "RGB with bbox/J1D1.jpeg",
          width = 850,
          height = 500)
...
rm(J1D1df, J1D1stem, J1D1newleaf, J1D1oldleaf, rgb, bbox.centre.newleaf, bbox.centre.oldleaf, bbox.centre.stem,
   bbox.newleaf, bbox.oldleaf, bbox.side, bbox.stem)
dev.off()
gc()
...
rgb <- brick(
  rasterFromXYZ(data.frame(J2D1df$x, J2D1df$y, J2D1df$`664`)),
  rasterFromXYZ(data.frame(J2D1df$x, J2D1df$y, J2D1df$`550`)),
  rasterFromXYZ(data.frame(J2D1df$x, J2D1df$y, J2D1df$`470`)))
...
plotRGB(rgb,
        ...
        stretch = "lin",
        axes = TRUE,
        main = "Juliet Plant 2 Day 1") 
lines(spPolygons(bbox.stem, crs = crs(rgb)), col = "red", lwd = 3) 
lines(spPolygons(bbox.newleaf, crs = crs(rgb)), col = "red", lwd = 3)
lines(spPolygons(bbox.oldleaf, crs = crs(rgb)), col = "red", lwd = 3) 
dev.print(device = jpeg,
          filename = "RGB with bbox/J2D1.jpeg",
          width = 850,
          height = 500)
...
rm(J2D1df, J2D1stem, J2D1newleaf, J2D1oldleaf, rgb, bbox.centre.newleaf, bbox.centre.oldleaf, bbox.centre.stem,
   bbox.newleaf, bbox.oldleaf, bbox.side, bbox.stem)
dev.off()
gc()
...
rgb <- brick(
  rasterFromXYZ(data.frame(J3D1df$x, J3D1df$y, J3D1df$`664`)),
  rasterFromXYZ(data.frame(J3D1df$x, J3D1df$y, J3D1df$`550`)),
  rasterFromXYZ(data.frame(J3D1df$x, J3D1df$y, J3D1df$`470`)))
...
plotRGB(rgb,
        ...
        stretch = "lin",
        axes = TRUE,
        main = "Juliet Plant 3 Day 1") 
lines(spPolygons(bbox.stem, crs = crs(rgb)), col = "red", lwd = 3) 
lines(spPolygons(bbox.newleaf, crs = crs(rgb)), col = "red", lwd = 3)
lines(spPolygons(bbox.oldleaf, crs = crs(rgb)), col = "red", lwd = 3) 
dev.print(device = jpeg,
          filename = "RGB with bbox/J3D1.jpeg",
          width = 850,
          height = 500)
...
rm(J3D1df, J3D1stem, J3D1newleaf, J3D1oldleaf, rgb, bbox.centre.newleaf, bbox.centre.oldleaf, bbox.centre.stem,
   bbox.newleaf, bbox.oldleaf, bbox.side, bbox.stem)
dev.off()
gc()
...
rgb <- brick(
  rasterFromXYZ(data.frame(J4D1df$x, J4D1df$y, J4D1df$`664`)),
  rasterFromXYZ(data.frame(J4D1df$x, J4D1df$y, J4D1df$`550`)),
  rasterFromXYZ(data.frame(J4D1df$x, J4D1df$y, J4D1df$`470`)))
...
plotRGB(rgb,
        ...
        stretch = "lin",
        axes = TRUE,
        main = "Juliet Plant 4 Day 1")
lines(spPolygons(bbox.stem, crs = crs(rgb)), col = "red", lwd = 3) 
lines(spPolygons(bbox.newleaf, crs = crs(rgb)), col = "red", lwd = 3)
lines(spPolygons(bbox.oldleaf, crs = crs(rgb)), col = "red", lwd = 3) 
dev.print(device = jpeg,
          filename = "RGB with bbox/J4D1.jpeg",
          width = 850,
          height = 500)
...
rm(J4D1df, J4D1stem, J4D1newleaf, J4D1oldleaf, rgb, bbox.centre.newleaf, bbox.centre.oldleaf, bbox.centre.stem,
   bbox.newleaf, bbox.oldleaf, bbox.side, bbox.stem)
dev.off()
gc()
...
rgb <- brick(
  rasterFromXYZ(data.frame(J5D1df$x, J5D1df$y, J5D1df$`664`)),
  rasterFromXYZ(data.frame(J5D1df$x, J5D1df$y, J5D1df$`550`)),
  rasterFromXYZ(data.frame(J5D1df$x, J5D1df$y, J5D1df$`470`)))
...
plotRGB(rgb,
        ...
        stretch = "lin",
        axes = TRUE,
        main = "Juliet Plant 5 Day 1")
lines(spPolygons(bbox.stem, crs = crs(rgb)), col = "red", lwd = 3) 
lines(spPolygons(bbox.newleaf, crs = crs(rgb)), col = "red", lwd = 3)
lines(spPolygons(bbox.oldleaf, crs = crs(rgb)), col = "red", lwd = 3) 
dev.print(device = jpeg,
          filename = "RGB with bbox/J5D1.jpeg",
          width = 850,
          height = 500)
...
rm(J5D1df, J5D1stem, J5D1newleaf, J5D1oldleaf, rgb, bbox.centre.newleaf, bbox.centre.oldleaf, bbox.centre.stem,
   bbox.newleaf, bbox.oldleaf, bbox.side, bbox.stem)
dev.off()
gc()

# 2.3.6 Juliet plant 6 (day 1) ####
...
J6D1df <- as.wide.df(J6D1)
rm(J6D1)

rgb <- brick(
  rasterFromXYZ(data.frame(J6D1df$x, J6D1df$y, J6D1df$`664`)),
  rasterFromXYZ(data.frame(J6D1df$x, J6D1df$y, J6D1df$`550`)),
  rasterFromXYZ(data.frame(J6D1df$x, J6D1df$y, J6D1df$`470`)))
...
plotRGB(rgb,
        ...
        stretch = "lin",
        axes = TRUE,
        main = "Juliet Plant 6 Day 1")
lines(spPolygons(bbox.stem, crs = crs(rgb)), col = "red", lwd = 3) 
lines(spPolygons(bbox.newleaf, crs = crs(rgb)), col = "red", lwd = 3)
lines(spPolygons(bbox.oldleaf, crs = crs(rgb)), col = "red", lwd = 3)

dev.print(device = jpeg,
          filename = "RGB with bbox/J6D1.jpeg",
          width = 850,
          height = 500)

J6D1stem <- subset(J6D1df, x >= bbox.stem[1,1] & x <= bbox.stem[3,1] &
                     y >= bbox.stem[1,2] & y <= bbox.stem[3,2])
J6D1stem$Tissue <- "Stem"

J6D1newleaf <- subset(J6D1df, x >= bbox.newleaf[1,1] & x <= bbox.newleaf[3,1] &
                        y >= bbox.newleaf[1,2] & y <= bbox.newleaf[3,2])
J6D1newleaf$Tissue <- "New leaf"

J6D1oldleaf <- subset(J6D1df, x >= bbox.oldleaf[1,1] & x <= bbox.oldleaf[3,1] &
                        y >= bbox.oldleaf[1,2] & y <= bbox.oldleaf[3,2])
J6D1oldleaf$Tissue <- "Old leaf"

data.J6D1 <- rbind(J6D1stem, J6D1newleaf, J6D1oldleaf)
data.J6D1$Time <- "Day 1"
data.J6D1$Variety <- "Juliet"
data.J6D1$Plant <- "Plant 6"
rm(J6D1df, J6D1stem, J6D1newleaf, J6D1oldleaf, rgb, bbox.centre.newleaf, bbox.centre.oldleaf, bbox.centre.stem,
   bbox.newleaf, bbox.oldleaf, bbox.side, bbox.stem)
dev.off()
gc()

# 2.3.7 Juliet plant 7 (day 1) ####
...
J7D1df <- as.wide.df(J7D1)
rm(J7D1)

rgb <- brick(
  rasterFromXYZ(data.frame(J7D1df$x, J7D1df$y, J7D1df$`664`)),
  rasterFromXYZ(data.frame(J7D1df$x, J7D1df$y, J7D1df$`550`)),
  rasterFromXYZ(data.frame(J7D1df$x, J7D1df$y, J7D1df$`470`)))
...
plotRGB(rgb,
        ...
        stretch = "lin",
        axes = TRUE,
        main = "Juliet Plant 7 Day 1")
lines(spPolygons(bbox.stem, crs = crs(rgb)), col = "red", lwd = 3) 
lines(spPolygons(bbox.newleaf, crs = crs(rgb)), col = "red", lwd = 3)
lines(spPolygons(bbox.oldleaf, crs = crs(rgb)), col = "red", lwd = 3) 
dev.print(device = jpeg,
          filename = "RGB with bbox/J7D1.jpeg",
          width = 850,
          height = 500)

J7D1stem <- subset(J7D1df, x >= bbox.stem[1,1] & x <= bbox.stem[3,1] &
                     y >= bbox.stem[1,2] & y <= bbox.stem[3,2])
J7D1stem$Tissue <- "Stem"

J7D1newleaf <- subset(J7D1df, x >= bbox.newleaf[1,1] & x <= bbox.newleaf[3,1] &
                        y >= bbox.newleaf[1,2] & y <= bbox.newleaf[3,2])
J7D1newleaf$Tissue <- "New leaf"

J7D1oldleaf <- subset(J7D1df, x >= bbox.oldleaf[1,1] & x <= bbox.oldleaf[3,1] &
                        y >= bbox.oldleaf[1,2] & y <= bbox.oldleaf[3,2])
J7D1oldleaf$Tissue <- "Old leaf"

data.J7D1 <- rbind(J7D1stem, J7D1newleaf, J7D1oldleaf)
data.J7D1$Time <- "Day 1"
data.J7D1$Variety <- "Juliet"
data.J7D1$Plant <- "Plant 7"
rm(J7D1df, J7D1stem, J7D1newleaf, J7D1oldleaf, rgb, bbox.centre.newleaf, bbox.centre.oldleaf, bbox.centre.stem,
   bbox.newleaf, bbox.oldleaf, bbox.side, bbox.stem)
dev.off()
gc()

# 2.3.8 Juliet plant 8 (day 1) ####
...
J8D1df <- as.wide.df(J8D1)
rm(J8D1)

rgb <- brick(
  rasterFromXYZ(data.frame(J8D1df$x, J8D1df$y, J8D1df$`664`)),
  rasterFromXYZ(data.frame(J8D1df$x, J8D1df$y, J8D1df$`550`)),
  rasterFromXYZ(data.frame(J8D1df$x, J8D1df$y, J8D1df$`470`)))
...
plotRGB(rgb,
        ...
        stretch = "lin",
        axes = TRUE,
        main = "Juliet Plant 8 Day 1")
lines(spPolygons(bbox.stem, crs = crs(rgb)), col = "red", lwd = 3) 
lines(spPolygons(bbox.newleaf, crs = crs(rgb)), col = "red", lwd = 3)
lines(spPolygons(bbox.oldleaf, crs = crs(rgb)), col = "red", lwd = 3) 
dev.print(device = jpeg,
          filename = "RGB with bbox/J8D1.jpeg",
          width = 850,
          height = 500)

J8D1stem <- subset(J8D1df, x >= bbox.stem[1,1] & x <= bbox.stem[3,1] &
                     y >= bbox.stem[1,2] & y <= bbox.stem[3,2])
J8D1stem$Tissue <- "Stem"

J8D1newleaf <- subset(J8D1df, x >= bbox.newleaf[1,1] & x <= bbox.newleaf[3,1] &
                        y >= bbox.newleaf[1,2] & y <= bbox.newleaf[3,2])
J8D1newleaf$Tissue <- "New leaf"

J8D1oldleaf <- subset(J8D1df, x >= bbox.oldleaf[1,1] & x <= bbox.oldleaf[3,1] &
                        y >= bbox.oldleaf[1,2] & y <= bbox.oldleaf[3,2])
J8D1oldleaf$Tissue <- "Old leaf"

data.J8D1 <- rbind(J8D1stem, J8D1newleaf, J8D1oldleaf)
data.J8D1$Time <- "Day 1"
data.J8D1$Variety <- "Juliet"
data.J8D1$Plant <- "Plant 8"
rm(J8D1df, J8D1stem, J8D1newleaf, J8D1oldleaf, rgb, bbox.centre.newleaf, bbox.centre.oldleaf, bbox.centre.stem,
   bbox.newleaf, bbox.oldleaf, bbox.side, bbox.stem)
dev.off()
gc()

# 2.3.9 Juliet day 1 data export ####
data.JD1 <- rbind(data.J1D1, data.J2D1, data.J3D1, data.J4D1, data.J5D1) #Add , data.J6D1, data.J7D1, data.J8D1
rm(data.J1D1, data.J2D1, data.J3D1, data.J4D1, data.J5D1, data.J6D1, data.J7D1, data.J8D1)
write_xlsx(data.JD1,"../Data/Excel\\Juliets day 1.xlsx")

## 2.4 Day 1 data export ####
data.D1 <- rbind(data.GD1, data.JD1)
rm(data.GD1, data.JD1, D1.dat, D1.hdr, FolderD1, i)
write_xlsx(data.D1,"../Data/Excel\\Data of the day 1.xlsx")
gc()
...
# 2.3.7 Juliet plant 7 (day 2) ERROR####
...
# 2.3.8 Juliet plant 8 (day 2) ERROR####
...
rm(data.D1, data.D2)
write_xlsx(data.raw,"../Data/Excel\\Data of the raw experimen.xlsx")
gc()
...
data.ag <- aggregate(. ~ Tissue + Time + Variety + Plant, data.raw, function(x) c(mean = mean(x), sd = sd(x)))
